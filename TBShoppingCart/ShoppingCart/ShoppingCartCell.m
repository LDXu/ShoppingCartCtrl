...
//    UITapGestureRecognizer *tap = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(seleButton:)];
//    [_selectButton addGestureRecognizer:tap];
...
//- (void)seleButton:(UIGestureRecognizer *)sender{
//    
//    if ([[(UIGestureRecognizer *)sender view] isKindOfClass:[UIButton class]]) {
